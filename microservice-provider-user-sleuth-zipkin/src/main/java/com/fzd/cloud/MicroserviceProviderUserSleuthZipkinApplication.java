...
public class MicroserviceProviderUserSleuthZipkinApplication {

    public static void main(String[] args) {
        SpringApplication.run(MicroserviceProviderUserSleuthZipkinApplication.class, args);
    }
    ...
    ApplicationRunner init(UserRepository userRepository){
        return args -> {
            ...
            User user2 = new User(2L,"account2", "李四", 28, new BigDecimal(100.00));
